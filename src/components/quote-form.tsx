...
type Item = { category: string; description: string; sizeSku: string; brand: string; quantity: number; unitPrice: number };
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="space-y-2">
              {items.map((it, i) => (
                <div key={i} className="grid grid-cols-12 items-end gap-2 rounded-md border border-slate-100 bg-slate-50 p-2">
                  ...
                  <div className="col-span-2"><Input className="h-8 text-xs" placeholder="Size / SKU" value={it.sizeSku} onChange={e => setItem(i, { sizeSku: e.target.value })} /></div>
