...
1. RHINO ships first; EVERFLOW after RHINO completes (architecture stays brand-config-driven so EVERFLOW is a config row + domain). 2. IDEAL service radius **35 miles**. 3. Consumer leads go to the **IDEAL front desk**. 4. Email via **Zoho Mail**, sender/front-desk notify `orlando@rhinotiresusa.com` (updated from info@ same day; SMTP credentials to be provided as env vars). RHINO wholesale phone confirmed: **(407) 777-5677**. 5. IDEAL NAP: 11423 Satellite Blvd, Orlando FL 32837 · (321) 682-0973 · Mon–Fri 8:00–5:30, Sat 8:00–2:00, Sun closed. 6. Referral expiry 14 days. 7. First products published to the website within 10 days of site readiness. MVP-A build approved and started.
