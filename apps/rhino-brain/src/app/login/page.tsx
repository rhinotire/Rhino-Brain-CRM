    ...
    <main className="flex min-h-screen items-center justify-center bg-ink-900 p-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 text-center">
          {/* full logo carries the wordmark + tagline; black bg blends into the page */}
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/rhino-brain-logo.png" alt="Rhino Brain — AI Business Command Center" className="mx-auto w-full max-w-xs rounded-2xl shadow-lg" />
        </div>
